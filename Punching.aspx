<%@ Page Language="C#" MasterPageFile="~/punch.master" AutoEventWireup="true" CodeFile="Punching.aspx.cs" Inherits="Punching" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
    <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="brt_id">
        <Columns>
        ...
        <asp:View ID="View2" runat="server">
            <table style="width: 536px">
                ...
                <tr>
                    <td style="width: 184px">
                        <asp:Label ID="Label5" runat="server" Text="Expected time" Font-Bold="True"></asp:Label></td>
                    <td style="width: 199px">
                ...
                <tr>
                    ...
                    <td style="width: 199px; height: 22px">
                        &nbsp;<asp:Label ID="Label1" runat="server" Width="79px" Font-Bold="True"></asp:Label>&nbsp;
                    </td>
